...
export default function IntroPhilosophy({ onScrollTo, onOpenBooking }) {
  ...
  return (
    <section id="intro" className="intro section">
      ...
      {/* Sensory Salon Tools: Overlapping Layered Deck */}
      <div className="salon-tools-section">
            ...
            {salonTools.map((tool) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="pill-name">{tool.name.split(" ")[0]} {tool.name.split(" ")[1] || ""}</span>
        ...
        {/* Overlapping Layered Deck Stage */}
              ...
              {salonTools.map((tool, idx) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      // Progressive cascading z-index for overlapping appearance
