...
export default function BookingModal({ isOpen, onClose, defaultService = "" }) {
  ...
  const paymentOptions = [
    {
      ...
      badge: "RECOMMENDED",
      icon: "🏪",
      desc: "Cash, UPI QR, or Card at the counter after your service"
    },
    {
      id: "upi",
      ...
      badge: "INSTANT QR",
      icon: "📱",
      desc: "Scan salon UPI QR code via Google Pay, PhonePe, or Paytm"
    },
    {
      id: "cash",
      ...
      badge: "DIRECT CASH",
      icon: "💵",
      desc: "Pay in cash directly to your barber at the chair"
    },
    {
      id: "card",
      ...
      badge: "POS MACHINE",
      icon: "💳",
      desc: "Swipe Visa, Mastercard, or RuPay at the salon desk"
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    const paymentLabels = {
      ...
      upi: "📱 UPI (Google Pay / PhonePe / Paytm QR)",
      cash: "💵 Cash on Arrival",
      card: "💳 Debit / Credit Card (POS Swipe)"
    };
